...
# Define initial DataFrame structure
...
if has_customer_id == "Yes":
    ...
    st.write(f"Your Customer ID is: {customer_id}")
...
stayers = st.number_input("How many people are staying?", min_value=1, max_value=3, step=1)
